...
export const OrderCard = ({ item }) => {
  ...
  return (
    <div className="flex justify-between items-center p-2 bg-slate-50 drop-shadow-sm my-2 rounded-lg mr-4">
      ...
      <div className="flex items-center gap-2">
        <div className="flex flex-col justify-between items-end h-20">
          ...
          <p className="text-lg font-semibold text-green-500">${price * quantity}</p>
        </div>
      </div>
    </div>
  );
